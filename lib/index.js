...
`,N=o.default.input`
  ...
  border: none;
  background: transparent;
`,O=({children:t})=>e.jsxs(e.Fragment,{children:[e.jsx(V,{}),e.jsx(a.ThemeProvider,{theme:T,children:t})]}),z=({theme:e})=>e.colors.gray,Z=o.default(R)`
  ${B}
...
`,G=s.default.memo((({title:t,onButtonClick:a,$isTodosEnabled:n})=>e.jsx(Z,{$isTodosEnabled:n,"data-testid":"calendar-button",onClick:a,children:t})));function J(e){const t=localStorage.getItem(e);return t?JSON.parse(t):[]}function _(e,t){localStorage.setItem(e,JSON.stringify(t))}const{Start:P,Between:q,End:K}=u,{Start:Q,Between:U,End:X}=u,{darkBlue:ee,blue:te,lightBlue:ae,white:ne,orange:re,lightGray:se,red:oe,black:ie}=M,de=({theme:e})=>e.colors.gray,le=({theme:e})=>e.colors.darkBlueHover,ce=o.default(R)`
  ...
  border-radius: ${({$rangeState:e})=>(e=>{switch(e){case P:return"8px 0 0 8px";case q:return"0";case K:return"0 8px 8px 0";default:return"8px"}})(e)};
  width: 32px;
  height: 38px;
...
`,{Week:Be,Month:Ve,Year:Re}=ye,{prevGrid:Ye,nextGrid:He}=We,Ie=s.default.memo((a=>{const{type:n,minDate:r,maxDate:s,isMondayFirst:o}=a,{selectedDate:i,firstDateOfWeek:d,selectedMonth:l,selectedYear:c,setFirstDateOfWeek:h,setSelectedMonth:u,setSelectedYear:g}=v();t.useEffect((()=>{h(p(i,o))}),[o,i,h]);const f=n===Re?`${c}`:`${m[l]} ${c}`,D=t.useCallback((e=>()=>{let t=l,a=c;const o=d;n===Ve&&(e===Te?(t=(l+1)%x,a=11===l?c+1:c):(t=(l-1+x)%x,a=0===l?c-1:c)),n===Be&&(e===Te?o.setDate(o.getDate()+7):o.setDate(o.getDate()-7),t=d.getMonth(),a=d.getFullYear(),h(new Date(o))),n===Re&&(e===Te?a++:a--);const i=new Date(a,t);(!r||i>=r)&&(!s||i<=s)&&(u(t),g(a))}),[d,s,r,l,c,h,u,g,n]);return e.jsxs(Le,{children:[e.jsx(Fe,{"data-testid":"prev-button",onClick:D("prevGreed"),children:e.jsx(H,{src:Ye})}),e.jsx(Ae,{"data-testid":"grid-slider",children:f}),e.jsx(Fe,{"data-testid":"next-button",onClick:D(Te),children:e.jsx(H,{src:He})})]})})),Ne=o.default.div`
  ...
  width: 32px;
  height: 32px;
`,Oe=s.default.memo((({weekday:t})=>e.jsx(Ne,{children:t}))),ze=s.default.memo((({isMondayFirst:a})=>{const n=t.useMemo((()=>{const e=Object.values(g);return a?[...e.slice(1),e[0]]:e}),[a]);return e.jsx(Y,{children:n.map((t=>e.jsx(Oe,{weekday:t},t)))})})),Ze=(e,a)=>{t.useEffect((()=>{if(!a)return;const t=t=>{e.current&&!e.current.contains(t.target)&&a(t)};return document.addEventListener("mousedown",t),()=>{document.removeEventListener("mousedown",t)}}),[e,a])},Ge=({theme:e})=>e.spaces.m,Je=({theme:e})=>e.spaces.s,_e=o.default(Y)`
  flex-direction: column;
...
`,Ue=o.default.div`
  position: absolute;
  top: 56%;
`,{calendar:Xe,clear:et}=We,tt=s.default.memo((({label:a,rangeValue:n,Calendar:r})=>{const[s,o]=t.useState(""),[i,d]=t.useState(""),[l,c]=t.useState(!1),u=t.useRef(null);Ze(u,(()=>{d(""),o(y(g)),c(!1)}));const{selectedDate:g}=v(),{setRange:m}=h();t.useEffect((()=>{o(y(g))}),[g]);const x=t.useCallback((()=>{d(""),o(y(g)),c((e=>!e))}),[g,c]),f=t.useCallback((()=>{d(""),o(""),m({rangeStart:void 0,rangeEnd:void 0}),c(!1)}),[m]);return e.jsxs(_e,{children:[e.jsxs(Ke,{children:[e.jsx(Pe,{children:a}),i&&e.jsx(Qe,{children:i})]}),e.jsxs(qe,{children:[e.jsx(H,{"data-testid":"calendar-icon-button",src:Xe,onClick:x}),e.jsx(dt,{inputValue:n||s,setError:d,setInputValue:o,setIsCalendarOpen:c}),s&&e.jsx(H,{"data-testid":"clear-icon-button",src:et,onClick:f})]}),e.jsx(Ue,{ref:u,children:l&&e.jsx(r,{})})]})})),at=o.default(Y)`
  gap: ${({theme:e})=>e.spaces.m}px;
  flex-direction: row;
`;s.default.memo((({Calendar:t})=>{const{range:a}=h(),n=a?.rangeStart?y(a.rangeStart):"",r=a?.rangeEnd?y(a.rangeEnd):"";return e.jsx(O,{children:e.jsxs(at,{children:[e.jsx(tt,{Calendar:t,label:"From",rangeValue:n}),e.jsx(tt,{Calendar:t,label:"To",rangeValue:r})]})})}));const nt="Enter Date in dd/mm/yyyy format",rt="/",st=/^[0-9/]*$/,ot=o.default(N)`
  margin: 0;
...
`,ft=o.default(R)`
  ...
  height: 40px;
  border-radius: 8px;
`,pt=s.default.memo((({todoText:t,onChange:a,onAddTask:n})=>{const r=()=>{n()};return e.jsxs(mt,{children:[e.jsx(xt,{children:e.jsx(N,{placeholder:"Enter todo text",type:"text",value:t,onChange:e=>{a(e)},onKeyDown:e=>{"Enter"===e.key&&r()}})}),e.jsx(ft,{onClick:r,children:"Add task"})]})})),Dt=({theme:e})=>e.spaces.m,wt=o.default(Y)`
  border: 1px solid ${({theme:e})=>e.colors.lightGray};
  gap: ${Dt}px;
  padding: ${Dt}px;
  justify-content: flex-start;
...
`,bt=s.default.memo((a=>{const{id:n,todoText:r,isDone:s,setTodos:o}=a,{selectedDate:i}=v(),d=t.useCallback((()=>{const e=i.toDateString(),t=J(e).map((e=>e.id===n?{...e,isDone:!e.isDone}:e));o(t),_(e,t)}),[n,i,o]),l=t.useCallback((()=>{const e=i.toDateString(),t=J(e).filter((e=>e.id!==n));o(t),_(e,t)}),[n,i,o]);return e.jsxs(wt,{children:[e.jsx("input",{checked:s,type:"checkbox",onChange:d}),e.jsx(yt,{$isDone:s,children:r}),e.jsx(Ct,{onClick:l,children:"Delete"})]})})),$t=o.default(Y)`
  height: 100%;
  width: 100%;
  position: fixed;
  top: 0;
