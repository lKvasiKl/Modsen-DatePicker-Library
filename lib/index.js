...
`,oe=n.styled.div`
  ...
  height: 3px;
  border-radius: 50%;
`,{Start:ie,End:de,Between:le}=S,ce=t.memo((n=>{const{dayOfWeek:a,isSelected:r=!1,isDisabled:s=!1,isWeekend:o=!1,isWithRange:d=!1,minDate:l,maxDate:c,isTodosEnabled:h=!1,isHoliday:g=!1}=n,{range:m,setRange:x}=i(),{setSelectedDate:u,setSelectedMonth:p,setSelectedYear:f}=N(),y=a.getDate(),D=a.getMonth(),w=a.getFullYear(),C=t.useCallback((()=>{if((!l||a>=l)&&(!c||a<=c))if(u(a),p(D),f(w),!d||m&&(m.rangeStart||m.rangeEnd)){const e=m&&m.rangeStart?m.rangeStart:a,t=a<e?[a,e]:[e,a];x({rangeStart:t[0],rangeEnd:t[1]})}else x({rangeStart:a,rangeEnd:void 0})}),[l,a,c,u,p,D,f,w,d,m,x]),b=Y(a.toDateString());return e.jsx(e.Fragment,{children:e.jsxs(se,{$isDisabled:s,$isHoliday:g,$isSelected:r,$isWeekend:o,$rangeState:(e=>{if(m&&m.rangeStart){if(e.getTime()===m.rangeStart.getTime())return ie;if(m.rangeEnd&&e.getTime()===m.rangeEnd.getTime())return de;if(m.rangeEnd&&e>m.rangeStart&&e<m.rangeEnd)return le}})(a),"data-testid":"day-of-week",onClick:C,children:[y,h&&0!==b.length&&e.jsx(oe,{})]})})})),he=(e,t)=>e.getMonth()!==t,ge=(e,t)=>new Date(e,t+1,0).getDate();const me=(e,t)=>e.getDate()===t.getDate()&&e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear(),xe=(e,t,n)=>{const a=ge(t,e),r=function(e,t){return new Date(e,t,1).getDay()}(t,e);let s;s=n?(7+r-1)%7:(7+r)%7;const{month:o,year:i}=((e,t)=>0===e?{month:11,year:t-1}:{month:e-1,year:t})(e,t),{month:d,year:l}=((e,t)=>11===e?{month:0,year:t+1}:{month:e+1,year:t})(e,t),c=ge(i,o),h=Array.from({length:s},((e,t)=>new Date(i,o,c-s+1+t))),g=Array.from({length:a},((n,a)=>new Date(t,e,a+1))),m=a+s,x=7*Math.ceil(6)-m,u=Array.from({length:x},((e,t)=>{const n=new Date(l,d,t+1);return n.getMonth()===d?n:null})).filter((e=>null!==e));return[...h,...g,...u]};var ue;!function(e){e[e.Week=1]="Week",e[e.Month=2]="Month",e[e.Year=3]="Year"}(ue||(ue={}));const pe=({theme:e})=>e.spaces.m,fe=n.styled.div`
  display: grid;
...
`,Ee=n.styled.h1`
  ...
  cursor: pointer;
`,{Week:Te,Month:We,Year:Le}=ue,{prevGrid:Fe,nextGrid:Ae}=je,Be=t.memo((n=>{const{type:a,minDate:r,maxDate:s,isMondayFirst:o}=n,{selectedDate:i,firstDateOfWeek:d,selectedMonth:l,selectedYear:c,setFirstDateOfWeek:h,setSelectedMonth:g,setSelectedYear:m}=N();t.useEffect((()=>{h(W(i,o))}),[o,i,h]);const x=a===Le?`${c}`:`${M[l]} ${c}`,u=t.useCallback((e=>()=>{let t=l,n=c;const o=d;a===We&&(e===Se?(t=(l+1)%E,n=11===l?c+1:c):(t=(l-1+E)%E,n=0===l?c-1:c)),a===Te&&(e===Se?o.setDate(o.getDate()+7):o.setDate(o.getDate()-7),t=d.getMonth(),n=d.getFullYear(),h(new Date(o))),a===Le&&(e===Se?n++:n--);const i=new Date(n,t);(!r||i>=r)&&(!s||i<=s)&&(g(t),m(n))}),[d,s,r,l,c,h,g,m,a]);return e.jsxs(ve,{children:[e.jsx(Me,{"data-testid":"prev-button",onClick:u("prevGreed"),children:e.jsx(D,{src:Fe})}),e.jsx(Ee,{"data-testid":"grid-slider",children:x}),e.jsx(Me,{"data-testid":"next-button",onClick:u(Se),children:e.jsx(D,{src:Ae})})]})})),Ve=n.styled.div`
  ${u}
...
`,qe=n.styled.div`
  position: absolute;
  top: 56%;
`,{calendar:Pe,clear:_e}=je,Ke=t.memo((({label:n,rangeValue:a,Calendar:r})=>{const[s,o]=t.useState(""),[d,l]=t.useState(""),[c,h]=t.useState(!1),g=t.useRef(null);Ie(g,(()=>{l(""),o(A(m)),h(!1)}));const{selectedDate:m}=N(),{setRange:x}=i();t.useEffect((()=>{o(A(m))}),[m]);const u=t.useCallback((()=>{l(""),o(A(m)),h((e=>!e))}),[m,h]),p=t.useCallback((()=>{l(""),o(""),x({rangeStart:void 0,rangeEnd:void 0}),h(!1)}),[x]);return e.jsxs(ze,{children:[e.jsxs(Ge,{children:[e.jsx(Oe,{children:n}),d&&e.jsx(Je,{children:d})]}),e.jsxs(Ze,{children:[e.jsx(D,{"data-testid":"calendar-icon-button",src:Pe,onClick:u}),e.jsx(at,{inputValue:a||s,setError:l,setInputValue:o,setIsCalendarOpen:h}),s&&e.jsx(D,{"data-testid":"clear-icon-button",src:_e,onClick:p})]}),e.jsx(qe,{ref:g,children:c&&e.jsx(r,{})})]})})),Qe=n.styled(y)`
  gap: ${({theme:e})=>e.spaces.m}px;
  flex-direction: row;
`;t.memo((({Calendar:t})=>{const{range:n}=i(),a=n?.rangeStart?A(n.rangeStart):"",r=n?.rangeEnd?A(n.rangeEnd):"";return e.jsx(b,{children:e.jsxs(Qe,{children:[e.jsx(Ke,{Calendar:t,label:"From",rangeValue:a}),e.jsx(Ke,{Calendar:t,label:"To",rangeValue:r})]})})}));const Ue="Enter Date in dd/mm/yyyy format",Xe="/",et=/^[0-9/]*$/,tt=n.styled(C)`
  margin: 0;
`,nt=t.memo((n=>{const{inputValue:a,setInputValue:r,setError:s,setIsCalendarOpen:o}=n,{setSelectedDate:i,setSelectedMonth:d,setSelectedYear:l}=N(),c=t.useCallback((e=>{s(""),"Backspace"===e.key&&a.endsWith(Xe)&&r(a.slice(0,-1))}),[a,s,r]),h=t.useCallback((()=>{o(!0)}),[]),g=t.useCallback((e=>{s(""),o(!0);const t=e.target.value;if(!et.test(t))return e.preventDefault(),void s(Ue);if(t.length>=10){r(t.substring(0,10));const e=t.split(Xe),n=parseInt(e[0]),a=parseInt(e[1])-1,o=parseInt(e[2]);if(o>9999)return void s(Ue);const c=new Date(o,a,n);c.getDate()!==n||c.getMonth()!==a||c.getFullYear()!==o?s("Invalid Date"):(i(c),d(a),l(o))}2===t.length||5===t.length?r(t+Xe):r(t)}),[s,r,o,i,d,l]);return e.jsx(tt,{"data-testid":"date-picker-input",placeholder:"Coose Date",type:"text",value:a,onChange:g,onFocus:h,onKeyDown:c})}));var at=nt;const rt=n.styled(y)`
  flex-direction: column;
`,st=n.styled.p`
  ${u}
...
`,ht=n.styled(f)`
  ...
  height: 40px;
  border-radius: 8px;
`,gt=t.memo((({todoText:t,onChange:n,onAddTask:a})=>{const r=()=>{a()};return e.jsxs(lt,{children:[e.jsx(ct,{children:e.jsx(C,{placeholder:"Enter todo text",type:"text",value:t,onChange:e=>{n(e)},onKeyDown:e=>{"Enter"===e.key&&r()}})}),e.jsx(ht,{onClick:r,children:"Add task"})]})})),mt=({theme:e})=>e.spaces.m,xt=n.styled(y)`
  border: 1px solid ${({theme:e})=>e.colors.lightGray};
  gap: ${mt}px;
  padding: ${mt}px;
  justify-content: flex-start;
...
`,ft=t.memo((n=>{const{id:a,todoText:r,isDone:s,setTodos:o}=n,{selectedDate:i}=N(),d=t.useCallback((()=>{const e=i.toDateString(),t=Y(e).map((e=>e.id===a?{...e,isDone:!e.isDone}:e));o(t),z(e,t)}),[a,i,o]),l=t.useCallback((()=>{const e=i.toDateString(),t=Y(e).filter((e=>e.id!==a));o(t),z(e,t)}),[a,i,o]);return e.jsxs(xt,{children:[e.jsx("input",{checked:s,type:"checkbox",onChange:d}),e.jsx(ut,{$isDone:s,children:r}),e.jsx(pt,{onClick:l,children:"Delete"})]})})),yt=n.styled(y)`
  height: 100%;
  width: 100%;
  position: fixed;
  top: 0;
...
`,{close:Ct}=je,bt=t.memo((({children:n,onClose:a})=>{const r=t.useRef(null);Ie(r,a);return e.jsx(yt,{children:e.jsxs(Dt,{ref:r,children:[e.jsx(wt,{"data-testid":"modal-close-button",onClick:()=>{a()},children:e.jsx(D,{src:Ct})}),n]})})})),$t=n.styled(y)`
  gap: ${({theme:e})=>e.spaces.m}px;
  justify-content: flex-start;
  flex-direction: column;
  width: 100%;
