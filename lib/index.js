...
`,N=o.default.input`
  ...
  border: none;
  background: transparent;
`,O=({children:t})=>e.jsxs(e.Fragment,{children:[e.jsx(R,{}),e.jsx(a.ThemeProvider,{theme:T,children:t})]}),z=({theme:e})=>e.colors.gray,Z=o.default(V)`
  ${B}
...
`,Ae=o.default.h1`
  ...
  cursor: pointer;
`,{Week:Be,Month:Re,Year:Ve}=ye,{prevGrid:Ye,nextGrid:He}=We,Ie=s.default.memo((a=>{const{type:n,minDate:r,maxDate:s,isMondayFirst:o}=a,{selectedDate:i,firstDateOfWeek:d,selectedMonth:l,selectedYear:c,setFirstDateOfWeek:h,setSelectedMonth:u,setSelectedYear:g}=v();t.useEffect((()=>{h(p(i,o))}),[o,i,h]);const f=n===Ve?`${c}`:`${m[l]} ${c}`,D=t.useCallback((e=>()=>{let t=l,a=c;const o=d;n===Re&&(e===Te?(t=(l+1)%x,a=11===l?c+1:c):(t=(l-1+x)%x,a=0===l?c-1:c)),n===Be&&(e===Te?o.setDate(o.getDate()+7):o.setDate(o.getDate()-7),t=d.getMonth(),a=d.getFullYear(),h(new Date(o))),n===Ve&&(e===Te?a++:a--);const i=new Date(a,t);(!r||i>=r)&&(!s||i<=s)&&(u(t),g(a))}),[d,s,r,l,c,h,u,g,n]);return e.jsxs(Le,{children:[e.jsx(Fe,{"data-testid":"prev-button",onClick:D("prevGreed"),children:e.jsx(H,{src:Ye})}),e.jsx(Ae,{"data-testid":"grid-slider",children:f}),e.jsx(Fe,{"data-testid":"next-button",onClick:D(Te),children:e.jsx(H,{src:He})})]})})),Ne=o.default.div`
  ${B}
...
`,Ue=o.default.div`
  position: absolute;
  top: 56%;
`,{calendar:Xe,clear:et}=We,tt=s.default.memo((({label:a,rangeValue:n,Calendar:r})=>{const[s,o]=t.useState(""),[i,d]=t.useState(""),[l,c]=t.useState(!1),u=t.useRef(null);Ze(u,(()=>{d(""),o(y(g)),c(!1)}));const{selectedDate:g}=v(),{setRange:m}=h();t.useEffect((()=>{o(y(g))}),[g]);const x=t.useCallback((()=>{d(""),o(y(g)),c((e=>!e))}),[g,c]),f=t.useCallback((()=>{d(""),o(""),m({rangeStart:void 0,rangeEnd:void 0}),c(!1)}),[m]);return e.jsxs(Pe,{children:[e.jsxs(Ke,{children:[e.jsx(_e,{children:a}),i&&e.jsx(Qe,{children:i})]}),e.jsxs(qe,{children:[e.jsx(H,{"data-testid":"calendar-icon-button",src:Xe,onClick:x}),e.jsx(dt,{inputValue:n||s,setError:d,setInputValue:o,setIsCalendarOpen:c}),s&&e.jsx(H,{"data-testid":"clear-icon-button",src:et,onClick:f})]}),e.jsx(Ue,{ref:u,children:l&&e.jsx(r,{})})]})})),at=o.default(Y)`
