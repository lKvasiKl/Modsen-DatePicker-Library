...
`,E=s.default.memo((({title:t,onButtonClick:a,$isTodosEnabled:n})=>e.jsx(M,{$isTodosEnabled:n,"data-testid":"calendar-button",onClick:a,children:t})));var W;!function(e){e.Start="Start",e.Between="Between",e.End="End"}(W||(W={}));const T={Sunday:"Su",Monday:"Mo",Tuesday:"Tu",Wednesday:"We",Thursday:"Th",Friday:"Fr",Saturday:"Sa"};var L;!function(e){e[e.January=0]="January",e[e.February=1]="February",e[e.March=2]="March",e[e.April=3]="April",e[e.May=4]="May",e[e.June=5]="June",e[e.July=6]="July",e[e.August=7]="August",e[e.September=8]="September",e[e.October=9]="October",e[e.November=10]="November",e[e.December=11]="December"}(L||(L={}));const F=12,A=[{name:"New Year's Day",date:new Date("2022-01-01")},{name:"Orthodox Christmas Eve",date:new Date("2022-01-06")},{name:"Orthodox Christmas Day",date:new Date("2022-01-07")},{name:"Defender of the Fatherland Day",date:new Date("2022-02-23")},{name:"International Women's Day",date:new Date("2022-03-08")},{name:"March Equinox",date:new Date("2022-03-20")},{name:"International Labor Day",date:new Date("2022-05-01")},{name:"Commemoration Day",date:new Date("2022-05-03")},{name:"Victory Day",date:new Date("2022-05-09")},{name:"June Solstice",date:new Date("2022-06-21")},{name:"Independence Day",date:new Date("2022-07-03")},{name:"September Equinox",date:new Date("2022-09-03")},{name:"Mother's Day",date:new Date("2022-10-14")},{name:"October Revolution Day",date:new Date("2022-11-07")},{name:"Christmas Eve",date:new Date("2022-12-24")},{name:"Christmas Day",date:new Date("2022-12-25")},{name:"New Year's Eve",date:new Date("2022-12-31")}],B=(e,t=!1)=>{const a=new Date(e);if(t){const e=a.getDay(),t=0===e?6:e-1;a.setDate(a.getDate()-t)}else a.setDate(a.getDate()-a.getDay());return a},V=e=>0===e.getDay()||6===e.getDay(),R=e=>A.some((t=>e.getDate()===t.date.getDate()&&e.getMonth()===t.date.getMonth())),Y=e=>`${e.getDate().toString().padStart(2,"0")}/${(e.getMonth()+1).toString().padStart(2,"0")}/${e.getFullYear().toString()}`,H=new Date,I=H.getMonth(),O=H.getFullYear(),z=B(H),N=t.createContext({firstDateOfWeek:z,selectedDate:H,selectedMonth:I,selectedYear:O,setFirstDateOfWeek:()=>{},setSelectedDate:()=>{},setSelectedMonth:()=>{},setSelectedYear:()=>{}}),Z=()=>t.useContext(N);function G(e){const t=localStorage.getItem(e);return t?JSON.parse(t):[]}function P(e,t){localStorage.setItem(e,JSON.stringify(t))}const{Start:J,Between:_,End:q}=W,{Start:K,Between:Q,End:U}=W,{darkBlue:X,blue:ee,lightBlue:te,white:ae,orange:ne,lightGray:re,red:se,black:oe}=u,ie=({theme:e})=>e.colors.gray,de=({theme:e})=>e.colors.darkBlueHover,le=o.default(C)`
  ...
  border-radius: ${({$rangeState:e})=>(e=>{switch(e){case J:return"8px 0 0 8px";case _:return"0";case q:return"0 8px 8px 0";default:return"8px"}})(e)};
  width: 32px;
  height: 38px;
...
`,Fe=o.default.h1`
  ...
  cursor: pointer;
`,{Week:Ae,Month:Be,Year:Ve}=we,{prevGrid:Re,nextGrid:Ye}=Ee,He=s.default.memo((a=>{const{type:n,minDate:r,maxDate:s,isMondayFirst:o}=a,{selectedDate:i,firstDateOfWeek:d,selectedMonth:l,selectedYear:c,setFirstDateOfWeek:h,setSelectedMonth:u,setSelectedYear:g}=Z();t.useEffect((()=>{h(B(i,o))}),[o,i,h]);const m=n===Ve?`${c}`:`${L[l]} ${c}`,x=t.useCallback((e=>()=>{let t=l,a=c;const o=d;n===Be&&(e===We?(t=(l+1)%F,a=11===l?c+1:c):(t=(l-1+F)%F,a=0===l?c-1:c)),n===Ae&&(e===We?o.setDate(o.getDate()+7):o.setDate(o.getDate()-7),t=d.getMonth(),a=d.getFullYear(),h(new Date(o))),n===Ve&&(e===We?a++:a--);const i=new Date(a,t);(!r||i>=r)&&(!s||i<=s)&&(u(t),g(a))}),[d,s,r,l,c,h,u,g,n]);return e.jsxs(Te,{children:[e.jsx(Le,{"data-testid":"prev-button",onClick:x("prevGreed"),children:e.jsx($,{src:Re})}),e.jsx(Fe,{"data-testid":"grid-slider",children:m}),e.jsx(Le,{"data-testid":"next-button",onClick:x(We),children:e.jsx($,{src:Ye})})]})})),Ie=o.default.div`
  ${w}
  ...
  width: 32px;
  height: 32px;
`,Oe=s.default.memo((({weekday:t})=>e.jsx(Ie,{children:t}))),ze=s.default.memo((({isMondayFirst:a})=>{const n=t.useMemo((()=>{const e=Object.values(T);return a?[...e.slice(1),e[0]]:e}),[a]);return e.jsx(b,{children:n.map((t=>e.jsx(Oe,{weekday:t},t)))})})),Ne=(e,a)=>{t.useEffect((()=>{if(!a)return;const t=t=>{e.current&&!e.current.contains(t.target)&&a(t)};return document.addEventListener("mousedown",t),()=>{document.removeEventListener("mousedown",t)}}),[e,a])},Ze=({theme:e})=>e.spaces.m,Ge=({theme:e})=>e.spaces.s,Pe=o.default(b)`
  flex-direction: column;
...
`,{calendar:Qe,clear:Ue}=Ee,Xe=s.default.memo((({label:a,rangeValue:n,Calendar:r})=>{const[s,o]=t.useState(""),[i,d]=t.useState(""),[l,c]=t.useState(!1),u=t.useRef(null);Ne(u,(()=>{d(""),o(Y(g)),c(!1)}));const{selectedDate:g}=Z(),{setRange:m}=h();t.useEffect((()=>{o(Y(g))}),[g]);const x=t.useCallback((()=>{d(""),o(Y(g)),c((e=>!e))}),[g,c]),f=t.useCallback((()=>{d(""),o(""),m({rangeStart:void 0,rangeEnd:void 0}),c(!1)}),[m]);return e.jsx(j,{children:e.jsxs(Pe,{children:[e.jsxs(qe,{children:[e.jsx(Je,{children:a}),i&&e.jsx(Ke,{children:i})]}),e.jsxs(_e,{children:[e.jsx($,{"data-testid":"calendar-icon-button",src:Qe,onClick:x}),e.jsx(ot,{inputValue:n||s,setError:d,setInputValue:o,setIsCalendarOpen:c}),s&&e.jsx($,{"data-testid":"clear-icon-button",src:Ue,onClick:f})]}),e.jsx("div",{ref:u,children:l&&e.jsx(r,{})})]})})})),et=o.default(b)`
  gap: ${({theme:e})=>e.spaces.m}px;
  flex-direction: row;
`;s.default.memo((({Calendar:t})=>{const{range:a}=h(),n=a?.rangeStart?Y(a.rangeStart):"",r=a?.rangeEnd?Y(a.rangeEnd):"";return e.jsx(j,{children:e.jsxs(et,{children:[e.jsx(Xe,{Calendar:t,label:"From",rangeValue:n}),e.jsx(Xe,{Calendar:t,label:"To",rangeValue:r})]})})}));const tt="Enter Date in dd/mm/yyyy format",at="/",nt=/^[0-9/]*$/,rt=o.default(S)`
  margin: 0;
...
`,yt=s.default.memo((a=>{const{id:n,todoText:r,isDone:s,setTodos:o}=a,{selectedDate:i}=Z(),d=t.useCallback((()=>{const e=i.toDateString(),t=G(e).map((e=>e.id===n?{...e,isDone:!e.isDone}:e));o(t),P(e,t)}),[n,i,o]),l=t.useCallback((()=>{const e=i.toDateString(),t=G(e).filter((e=>e.id!==n));o(t),P(e,t)}),[n,i,o]);return e.jsxs(pt,{children:[e.jsx("input",{checked:s,type:"checkbox",onChange:d}),e.jsx(Dt,{$isDone:s,children:r}),e.jsx(wt,{onClick:l,children:"Delete"})]})})),Ct=o.default(b)`
  height: 100%;
  width: 100%;
  position: fixed;
  top: 0;
...
`,{close:kt}=Ee,St=s.default.memo((({children:a,onClose:n})=>{const r=t.useRef(null);Ne(r,n);return e.jsx(Ct,{children:e.jsxs(bt,{ref:r,children:[e.jsx($t,{"data-testid":"modal-close-button",onClick:()=>{n()},children:e.jsx($,{src:kt})}),a]})})})),jt=o.default(b)`
  gap: ${({theme:e})=>e.spaces.m}px;
  justify-content: flex-start;
  flex-direction: column;
  width: 100%;
