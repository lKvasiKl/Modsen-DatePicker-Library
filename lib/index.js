...
`,O=o.default.input`
  ...
  border: none;
  background: transparent;
`,z=({children:t})=>e.jsxs(e.Fragment,{children:[e.jsx(V,{}),e.jsx(a.ThemeProvider,{theme:L,children:t})]}),Z=({theme:e})=>e.colors.gray,G=o.default(Y)`
  ${R}
...
`,J=s.default.memo((({title:t,onButtonClick:a,$isTodosEnabled:n})=>e.jsx(G,{$isTodosEnabled:n,"data-testid":"calendar-button",onClick:a,children:t})));function P(e){const t=localStorage.getItem(e);return t?JSON.parse(t):[]}function _(e,t){localStorage.setItem(e,JSON.stringify(t))}const{Start:q,Between:K,End:Q}=g,{Start:U,Between:X,End:ee}=g,{darkBlue:te,blue:ae,lightBlue:ne,white:re,orange:se,lightGray:oe,red:ie,black:de}=E,le=({theme:e})=>e.colors.gray,ce=({theme:e})=>e.colors.darkBlueHover,he=o.default(Y)`
...
`,Be=o.default.h1`
  ...
  cursor: pointer;
`,{Week:Re,Month:Ve,Year:Ye}=Ce,{prevGrid:He,nextGrid:Ie}=Te,Ne=s.default.memo((a=>{const{type:n,minDate:r,maxDate:s,isMondayFirst:o}=a,{selectedDate:i,firstDateOfWeek:d,selectedMonth:l,selectedYear:c,setFirstDateOfWeek:h,setSelectedMonth:u,setSelectedYear:g}=M();t.useEffect((()=>{h(D(i,o))}),[o,i,h]);const m=n===Ye?`${c}`:`${x[l]} ${c}`,p=t.useCallback((e=>()=>{let t=l,a=c;const o=d;n===Ve&&(e===Le?(t=(l+1)%f,a=11===l?c+1:c):(t=(l-1+f)%f,a=0===l?c-1:c)),n===Re&&(e===Le?o.setDate(o.getDate()+7):o.setDate(o.getDate()-7),t=d.getMonth(),a=d.getFullYear(),h(new Date(o))),n===Ye&&(e===Le?a++:a--);const i=new Date(a,t);(!r||i>=r)&&(!s||i<=s)&&(u(t),g(a))}),[d,s,r,l,c,h,u,g,n]);return e.jsxs(Fe,{children:[e.jsx(Ae,{"data-testid":"prev-button",onClick:p("prevGreed"),children:e.jsx(I,{src:He})}),e.jsx(Be,{"data-testid":"grid-slider",children:m}),e.jsx(Ae,{"data-testid":"next-button",onClick:p(Le),children:e.jsx(I,{src:Ie})})]})})),Oe=o.default.div`
  ${R}
  ...
  width: 32px;
  height: 32px;
`,ze=s.default.memo((({weekday:t})=>e.jsx(Oe,{children:t}))),Ze=s.default.memo((({isMondayFirst:a})=>{const n=t.useMemo((()=>{const e=Object.values(m);return a?[...e.slice(1),e[0]]:e}),[a]);return e.jsx(H,{children:n.map((t=>e.jsx(ze,{weekday:t},t)))})})),Ge=(e,a)=>{t.useEffect((()=>{if(!a)return;const t=t=>{e.current&&!e.current.contains(t.target)&&a(t)};return document.addEventListener("mousedown",t),()=>{document.removeEventListener("mousedown",t)}}),[e,a])},Je=({theme:e})=>e.spaces.m,Pe=({theme:e})=>e.spaces.s,_e=o.default(H)`
  flex-direction: column;
...
`,ut=o.default.span`
  ...
  text-align: center;
`;class gt extends t.Component{constructor(e){super(e),this.state={hasError:!1,error:null,errorInfo:null}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){this.setState({errorInfo:t})}render(){const{hasError:t,error:a,errorInfo:n}=this.state;return t?e.jsxs(ct,{"data-testid":"error-boundary",children:[e.jsx(N,{children:"An error has occured"}),e.jsx(ht,{children:a&&a.toString()}),e.jsx(ut,{children:"(╯°□°）╯︵ ┻━┻"}),e.jsx(ut,{children:n&&n.componentStack})]}):this.props.children}}const mt=({theme:e})=>e.spaces.m,xt=o.default(H)`
  gap: ${mt}px;
  width: 100%;
`,ft=o.default(H)`
...
`,pt=o.default(Y)`
  ...
  height: 40px;
  border-radius: 8px;
`,Dt=s.default.memo((({todoText:t,onChange:a,onAddTask:n})=>{const r=()=>{n()};return e.jsxs(xt,{children:[e.jsx(ft,{children:e.jsx(O,{placeholder:"Enter todo text",type:"text",value:t,onChange:e=>{a(e)},onKeyDown:e=>{"Enter"===e.key&&r()}})}),e.jsx(pt,{onClick:r,children:"Add task"})]})})),wt=({theme:e})=>e.spaces.m,yt=o.default(H)`
  border: 1px solid ${({theme:e})=>e.colors.lightGray};
  gap: ${wt}px;
  padding: ${wt}px;
  justify-content: flex-start;
...
`,{close:vt}=Te,Mt=s.default.memo((({children:a,onClose:n})=>{const r=t.useRef(null);Ge(r,n);return e.jsx(kt,{children:e.jsxs(St,{ref:r,children:[e.jsx(jt,{"data-testid":"modal-close-button",onClick:()=>{n()},children:e.jsx(I,{src:vt})}),a]})})})),Et=o.default(H)`
  gap: ${({theme:e})=>e.spaces.m}px;
  justify-content: flex-start;
  flex-direction: column;
  width: 100%;
