...
/// <reference types="react" />
export declare const DayOfWeekGridContainer: import("styled-components").IStyledComponent<"web", {
...
export declare const MonthText: import("styled-components").IStyledComponent<"web", {
