...
`,G=m`
  ...
  align-items: center;
`,j=m`
  font-size: ${O.fontSize.s}px;
  font-weight: ${O.fontWeight.m};
  font-style: normal;
  line-height: normal;
`,J=p`
    * {
        font-family: ${O.fontFamily.openSans};
...
`,K=g.h1`
  ...
  font-size:  ${O.fontSize.xl}px;
  font-weight: ${O.fontWeight.l};
`,Q=g.input`
  ${j}

  margin: ${z.m}px;
  font-size: ${O.fontSize.l}px;
  font-weight: ${O.fontWeight.s};
  width: 100%;
  border: none;
  background: transparent;
`,U=({children:a})=>t(n,{children:[e(J,{}),e(u,{theme:N,children:a})]}),X=({theme:e})=>e.colors.gray,ee=g(P)`
  ${j}
...
`,Ge=g.h1`
  ...
  cursor: pointer;
`,{Week:je,Month:Je,Year:Pe}=Te,{prevGrid:_e,nextGrid:qe}=ze,Ke=a.memo((n=>{const{type:a,minDate:r,maxDate:o,isMondayFirst:i}=n,{selectedDate:d,firstDateOfWeek:c,selectedMonth:h,selectedYear:g,setFirstDateOfWeek:m,setSelectedMonth:p,setSelectedYear:u}=H();l((()=>{m(M(d,i))}),[i,d,m]);const f=a===Pe?`${g}`:`${k[h]} ${g}`,x=s((e=>()=>{let t=h,n=g;const i=c;a===Je&&(e===Ne?(t=(h+1)%S,n=11===h?g+1:g):(t=(h-1+S)%S,n=0===h?g-1:g)),a===je&&(e===Ne?i.setDate(i.getDate()+7):i.setDate(i.getDate()-7),t=c.getMonth(),n=c.getFullYear(),m(new Date(i))),a===Pe&&(e===Ne?n++:n--);const s=new Date(n,t);(!r||s>=r)&&(!o||s<=o)&&(p(t),u(n))}),[c,o,r,h,g,m,p,u,a]);return t(Re,{children:[e(Ze,{"data-testid":"prev-button",onClick:x("prevGreed"),children:e(q,{src:_e})}),e(Ge,{"data-testid":"grid-slider",children:f}),e(Ze,{"data-testid":"next-button",onClick:x(Ne),children:e(q,{src:qe})})]})})),Qe=g.div`
  ${j}
...
`,dt=g.div`
  position: absolute;
  top: 56%;
`,{calendar:lt,clear:ct}=ze,ht=a.memo((({label:n,rangeValue:a,Calendar:r})=>{const[i,d]=o(""),[h,g]=o(""),[m,p]=o(!1),u=c(null);et(u,(()=>{g(""),d(T(f)),p(!1)}));const{selectedDate:f}=H(),{setRange:x}=$();l((()=>{d(T(f))}),[f]);const D=s((()=>{g(""),d(T(f)),p((e=>!e))}),[f,p]),w=s((()=>{g(""),d(""),x({rangeStart:void 0,rangeEnd:void 0}),p(!1)}),[x]);return e(U,{children:t(at,{children:[t(it,{children:[e(rt,{children:n}),h&&e(st,{children:h})]}),t(ot,{children:[e(q,{"data-testid":"calendar-icon-button",src:lt,onClick:D}),e(Dt,{inputValue:a||i,setError:g,setInputValue:d,setIsCalendarOpen:p}),i&&e(q,{"data-testid":"clear-icon-button",src:ct,onClick:w})]}),e(dt,{ref:u,children:m&&e(r,{})})]})})})),gt=g(_)`
...
`;a.memo((({Calendar:n})=>{const{range:a}=$(),r=a?.rangeStart?T(a.rangeStart):"",o=a?.rangeEnd?T(a.rangeEnd):"";return e(U,{children:t(gt,{children:[e(ht,{Calendar:n,label:"From",rangeValue:r}),e(ht,{Calendar:n,label:"To",rangeValue:o})]})})}));const mt="Enter Date in dd/mm/yyyy format",pt="/",ut=/^[0-9/]*$/,ft=g(Q)`
  margin: 0;
`,xt=a.memo((t=>{const{inputValue:n,setInputValue:a,setError:r,setIsCalendarOpen:o}=t,{setSelectedDate:i,setSelectedMonth:d,setSelectedYear:l}=H(),c=s((e=>{r(""),"Backspace"===e.key&&n.endsWith(pt)&&a(n.slice(0,-1))}),[n,r,a]),h=s((()=>{o(!0)}),[]),g=s((e=>{r(""),o(!0);const t=e.target.value;if(!ut.test(t))return e.preventDefault(),void r(mt);if(t.length>=10){a(t.substring(0,10));const e=t.split(pt),n=parseInt(e[0]),o=parseInt(e[1])-1,s=parseInt(e[2]);if(s>9999)return void r(mt);const c=new Date(s,o,n);c.getDate()!==n||c.getMonth()!==o||c.getFullYear()!==s?r("Invalid Date"):(i(c),d(o),l(s))}2===t.length||5===t.length?a(t+pt):a(t)}),[r,a,o,i,d,l]);return e(ft,{"data-testid":"date-picker-input",placeholder:"Coose Date",type:"text",value:n,onChange:g,onFocus:h,onKeyDown:c})}));var Dt=xt;const wt=g(_)`
  flex-direction: column;
`,yt=g.p`
  ${j}
...
`,{close:Yt}=ze,Ht=a.memo((({children:n,onClose:a})=>{const r=c(null);et(r,a);return e(At,{children:t(Bt,{ref:r,children:[e(Vt,{"data-testid":"modal-close-button",onClick:()=>{a()},children:e(q,{src:Yt})}),n]})})})),It=g(_)`
  gap: ${({theme:e})=>e.spaces.m}px;
  justify-content: flex-start;
  flex-direction: column;
  width: 100%;
  max-height: 350px;
  overflow: auto;
`,Ot=a.memo((({onClose:n})=>{const[a,r]=o(""),[i,d]=o([]),{selectedDate:c}=H();l((()=>{const e=ne(c.toDateString());e&&d(e)}),[c]);const h=s((()=>{n()}),[n]),g=s((e=>{r(e.target.value)}),[]),m=s((()=>{if(""!==a.trim()){const e=c.toDateString(),t=[...i],n={id:String((new Date).getTime()),todoText:a,isDone:!1};t.push(n),d(t),ae(e,t),r("")}}),[a,i,c]),p=i.map((({id:t,...n})=>e(Ft,{id:t,setTodos:d,...n},t)));return t(Ht,{"data-testid":"todo-modal",onClose:h,children:[e(K,{children:"Todos for {Date}".replace("{Date}",c.toDateString())}),e(Mt,{todoText:a,onAddTask:m,onChange:g}),e(It,{children:0!==i.length?p:"Add some tasks"})]})})),zt=g(_)`
  background-color: ${({theme:e})=>e.colors.white};
  border: 1px solid ${({theme:e})=>e.colors.gray};
  ...
  flex-direction: column;
  width: fit-content;
`,{Month:Nt,Week:Rt}=Te,Zt=n=>{const{type:a=Nt,isMondayFirst:r,isWeekendDate:o,isWithRange:i,minDate:d,maxDate:l,isTodosEnabled:c,isHolidayDate:h}=n,{range:g,setRange:m}=$(),p=s((()=>{m&&m(void 0)}),[m]),u=i&&Boolean(g?.rangeStart)&&Boolean(g?.rangeEnd);return e(U,{children:e(bt,{children:t(Y,{children:[t(zt,{$isRangeExist:u,$isTodosEnabled:c,"data-testid":"calendar",children:[e(Ke,{isMondayFirst:r,maxDate:l,minDate:d,type:a}),(a===Rt||a===Nt)&&e(Xe,{isMondayFirst:r}),e(Oe,{isHolidayDate:h,isMondayFirst:r,isTodosEnabled:c,isWeekendDate:o,isWithRange:i,maxDate:l,minDate:d,type:a})]}),u&&e(te,{$isTodosEnabled:c,title:"Clear Range",onButtonClick:p})]})})})};class Gt{calendar;constructor(){this.calendar=Zt}addDecorator(e){this.calendar=e(this.calendar)}getCalendar(){return this.calendar}}const jt=t=>{const n=n=>e(t,{...n,isHolidayDate:W}),a=t.displayName||t.name;return n.displayName=`withHolidays(${a})`,n},Jt=t=>{const n=n=>e(t,{...n,isMondayFirst:!0}),a=t.displayName||t.name;return n.displayName=`withMondayFirst(${a})`,n},Pt=t=>{const n=n=>e(t,{...n,isWithRange:!0}),a=t.displayName||t.name;return n.displayName=`withRange(${a})`,n};const _t=n=>{const a=a=>{const[r,i]=o(!1),{selectedDate:d}=H(),h=function(e="todo-portal-wrapper"){const t=c(null);return l((()=>{let n=document.getElementById(e),a=!1;return n||(a=!0,n=document.createElement("div"),n.id=e,document.body.appendChild(n)),t.current=n,()=>{a&&n?.parentNode&&n.parentNode.removeChild(n)}}),[e]),e=>{if(t.current)return f.createPortal(e,t.current)}}(),g=s((()=>{i(!0)}),[]),m=s((()=>{i(!1)}),[]),p=0!==ne(d.toDateString()).length;return t(U,{children:[e(n,{...a,isTodosEnabled:!0}),e(te,{title:p?"View Tasks":"Add Task",onButtonClick:g}),r&&h(e(Ot,{onClose:m}))]})},r=n.displayName||n.name;return a.displayName=`withTodo(${r})`,a},qt=t=>{const n=n=>e(t,{...n,isWeekendDate:E}),a=t.displayName||t.name;return n.displayName=`withWeekendsDays(${a})`,n};export{Gt as CalendarService,ht as DatePicker,y as DateProvider,$ as useDate,jt as withHolidays,Jt as withMondayFirst,Pt as withRange,_t as withTodos,qt as withWeekends};
