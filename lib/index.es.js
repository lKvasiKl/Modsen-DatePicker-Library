...
`,Ge=g.h1`
  ...
  cursor: pointer;
`,{Week:je,Month:Je,Year:Pe}=Te,{prevGrid:_e,nextGrid:qe}=Oe,Ke=a.memo((n=>{const{type:a,minDate:r,maxDate:o,isMondayFirst:i}=n,{selectedDate:d,firstDateOfWeek:c,selectedMonth:h,selectedYear:g,setFirstDateOfWeek:m,setSelectedMonth:p,setSelectedYear:u}=H();l((()=>{m(M(d,i))}),[i,d,m]);const f=a===Pe?`${g}`:`${k[h]} ${g}`,x=s((e=>()=>{let t=h,n=g;const i=c;a===Je&&(e===ze?(t=(h+1)%S,n=11===h?g+1:g):(t=(h-1+S)%S,n=0===h?g-1:g)),a===je&&(e===ze?i.setDate(i.getDate()+7):i.setDate(i.getDate()-7),t=c.getMonth(),n=c.getFullYear(),m(new Date(i))),a===Pe&&(e===ze?n++:n--);const s=new Date(n,t);(!r||s>=r)&&(!o||s<=o)&&(p(t),u(n))}),[c,o,r,h,g,m,p,u,a]);return t(Re,{children:[e(Ze,{"data-testid":"prev-button",onClick:x("prevGreed"),children:e(q,{src:_e})}),e(Ge,{"data-testid":"grid-slider",children:f}),e(Ze,{"data-testid":"next-button",onClick:x(ze),children:e(q,{src:qe})})]})})),Qe=g.div`
  ${j}
