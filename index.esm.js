...
import styled, { css, createGlobalStyle, ThemeProvider, styled as styled$1 } from 'styled-components';
import React, { createContext, useContext, Component, useCallback, useEffect, useRef, useState, useMemo } from 'react';
...
var displayFlex = css(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  display: flex;\n"], ["\n  display: flex;\n"])));
var flexColumn = css(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  ", "\n  flex-direction: column;\n"], ["\n  ", "\n  flex-direction: column;\n"])), displayFlex);
var contentCenter = css(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  justify-content: center;\n  align-items: center;\n"], ["\n  justify-content: center;\n  align-items: center;\n"])));
var baseText = css(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  font-size: ", "px;\n  font-weight: ", ";\n  font-style: normal;\n  line-height: normal;\n"], ["\n  font-size: ", "px;\n  font-weight: ", ";\n  font-style: normal;\n  line-height: normal;\n"])), FONTS.fontSize.s, FONTS.fontWeight.m);
...
var ThemeWrapper = function (_a) {
    ...
    return (jsxs(Fragment, { children: [jsx(GlobalStyle, {}), jsx(ThemeProvider, { theme: THEME, children: children })] }));
};

var defaultMinDate = new Date(2022, 0, 1);
var defaultMaxDate = new Date(2035, 11, 0);
var DateContext = createContext({
...
var ErrorBoundaryContainer = styled$1(Container)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  flex-direction: column;\n"], ["\n  flex-direction: column;\n"])));
var Error$2 = styled$1.p(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  ", "\n  color: ", ";\n"], ["\n  ", "\n  color: ", ";\n"])), baseText, redColor$2);
var Text = styled$1.span(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  ", "\n  text-align: center;\n"], ["\n  ", "\n  text-align: center;\n"])), baseText);
...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        ...
        if (hasError) {
            return (jsxs(ErrorBoundaryContainer, { "data-testid": "error-boundary", children: [jsx(Title$1, { children: ERROR_TITLE }), jsx(Error$2, { children: error && error.toString() }), jsx(Text, { children: ERROR_TEXT }), jsx(Text, { children: errorInfo && errorInfo.componentStack })] }));
        }
...
var CalendarContainer = styled$1(Container)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  padding: ", "px;\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-bottom: ", ";\n  border-radius: ", ";\n  flex-direction: column;\n"], ["\n  padding: ", "px;\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-bottom: ", ";\n  border-radius: ", ";\n  flex-direction: column;\n"])), spaceM$9, whiteColor$4, grayColor$4, function (_a) {
...
var Calendar = function (_a) {
    ...
    var handlClearButtonClick = useCallback(function () {
        if (setRange) {
            setRange(undefined);
        }
    }, [setRange]);
    return (jsx(ThemeWrapper, { children: jsxs(ErrorBoundary, { children: [jsxs(CalendarContainer, { "$isWithRange": isWithRange, "data-testid": "calendar", children: [jsx(GridSlider, { isMondayFirst: isMondayFirst, maxDate: maxDate, minDate: minDate, type: type }), type === CALENDAR_TYPES.Week ||
                            (type === CALENDAR_TYPES.Month && (jsx(WeekdaysHeader, { isMondayFirst: isMondayFirst }))), jsx(DayOfWeekGrid, { isHolidayDate: isHolidayDate, isMondayFirst: isMondayFirst, isTodosEnabled: isTodosEnabled, isWeekendDate: isWeekendDate, isWithRange: isWithRange, maxDate: maxDate, minDate: minDate, type: type })] }), isWithRange && (jsx(ClearButton, { title: "Clear", onClearClick: handlClearButtonClick }))] }) }));
};
...
var ClearRangeButton = styled$1(Button)(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  ", "\n  padding: ", "px 0;\n  border: 1px solid ", ";\n  background-color: ", ";\n  border-radius: 0 0 8px 8px;\n  width: 100%;\n  min-width: 224px;\n  justify-content: space-between;\n\n  &:hover {\n    background-color: ", ";\n  }\n"], ["\n  ", "\n  padding: ", "px 0;\n  border: 1px solid ", ";\n  background-color: ", ";\n  border-radius: 0 0 8px 8px;\n  width: 100%;\n  min-width: 224px;\n  justify-content: space-between;\n\n  &:hover {\n    background-color: ", ";\n  }\n"])), baseText, spaceS$2, grayColor$3, whiteColor$3, grayColor$3);
var templateObject_1$b;

var ClearButton = React.memo(function (_a) {
    var title = _a.title, onClearClick = _a.onClearClick;
    return (jsx(ClearRangeButton, { "data-testid": "range-clear-button", onClick: onClearClick, children: title }));
});
...
var ModalContainer = styled$1(Container)(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  height: 100vh;\n  width: 100vw;\n  position: fixed;\n  top: 0;\n  left: 0;\n"], ["\n  height: 100vh;\n  width: 100vw;\n  position: fixed;\n  top: 0;\n  left: 0;\n"])));
var ModalWindow = styled$1(Container)(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  box-shadow: 0px 0px 13px 0px ", ";\n  background-color: ", ";\n  border: 1px solid ", ";\n  padding: ", "px;\n  flex-direction: column;\n  width: 100%;\n  max-width: 550px;\n  height: fit-content;\n  position: relative;\n  border-radius: 10px;\n"], ["\n  box-shadow: 0px 0px 13px 0px ", ";\n  background-color: ", ";\n  border: 1px solid ", ";\n  padding: ", "px;\n  flex-direction: column;\n  width: 100%;\n  max-width: 550px;\n  height: fit-content;\n  position: relative;\n  border-radius: 10px;\n"])), lightGrayColor$2, whiteColor$2, grayColor$2, spaceM$8);
var CloseButton = styled$1(Button)(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  align-self: flex-end;\n  transition: transform 0.3s;\n\n  &:hover {\n    transform: scale(1.15);\n  }\n"], ["\n  align-self: flex-end;\n  transition: transform 0.3s;\n\n  &:hover {\n    transform: scale(1.15);\n  }\n"])));
...
var Modal = React.memo(function (_a) {
    ...
    return (jsx(ModalContainer, { children: jsxs(ModalWindow, { ref: modalRef, children: [jsx(CloseButton, { "data-testid": "modal-close-button", onClick: handleCloseButtonClick, children: jsx(Icon, { src: CloseIcon }) }), children] }) }));
});
...
var TasksWrapper = styled$1(Container)(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  gap: ", "px;\n  justify-content: flex-start;\n  flex-direction: column;\n  width: 100%;\n  max-height: 350px;\n  overflow: auto;\n"], ["\n  gap: ", "px;\n  justify-content: flex-start;\n  flex-direction: column;\n  width: 100%;\n  max-height: 350px;\n  overflow: auto;\n"])), spaceM$7);
var templateObject_1$9;

var TodosModal = React.memo(function (_a) {
    var onClose = _a.onClose;
    var _b = useState(""), todoText = _b[0], setTodoText = _b[1];
    var _c = useState([]), todos = _c[0], setTodos = _c[1];
    ...
    var TODO_ITEMS = todos.map(function (todo) { return (jsx(TodoItem$1, { id: todo.id, isDone: todo.isDone, setTodos: setTodos, todoText: todo.todoText }, todo.id)); });
    return (jsxs(Modal, { "data-testid": "todo-modal", onClose: handleCloseModal, children: [jsx(Title$1, { children: TITLE_TEXT.replace("{Date}", selectedDate.toDateString()) }), jsx(TodoInput$1, { todoText: todoText, onAddTask: handleAddTodo, onChange: handleInputChange }), jsx(TasksWrapper, { children: todos.length !== 0 ? TODO_ITEMS : HINT })] }));
});
...
var DayOfWeekButton = styled$1(Button)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  padding: ", "px;\n  border-radius: ", ";\n  width: 32px;\n  height: 32px;\n\n  &:hover {\n    background-color: ", ";\n  }\n"], ["\n  background-color: ", ";\n  color: ", ";\n  padding: ", "px;\n  border-radius: ", ";\n  width: 32px;\n  height: 32px;\n\n  &:hover {\n    background-color: ", ";\n  }\n"])), function (_a) {
...
var DayofWeek = React.memo(function (_a) {
    ...
    var _k = useState(false), isTodoModalOpen = _k[0], setIsTodoModalOpen = _k[1];
    ...
    var handleSelectDate = useCallback(function () {
    ...
    var handleCloseTodoModal = useCallback(function () {
    ...
    return (jsxs(Fragment, { children: [jsx(DayOfWeekButton, { "$isDisabled": isDisabled, "$isHoliday": isHoliday, "$isSelected": isSelected, "$isWeekend": isWeekend, "$rangeState": getRangeState(dayOfWeek), "data-testid": "day-of-week", onClick: handleSelectDate, children: day }), isTodosEnabled &&
                isTodoModalOpen &&
                todosPortal(jsx(TodosModal, { onClose: handleCloseTodoModal }))] }));
});
...
var DayOfWeekGridContainer = styled$1.div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(7, 1fr);\n  grid-template-rows: repeat(1, 1fr);\n  width: fit-content;\n"], ["\n  display: grid;\n  grid-template-columns: repeat(7, 1fr);\n  grid-template-rows: repeat(1, 1fr);\n  width: fit-content;\n"])));
var YearCalendarContainer = styled$1(DayOfWeekGridContainer)(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: repeat(3, 1fr);\n  align-items: baseline;\n"], ["\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: repeat(3, 1fr);\n  align-items: baseline;\n"])));
var MiniCalendarWrapper = styled$1(Container)(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  padding: ", "px;\n  flex-direction: column;\n"], ["\n  padding: ", "px;\n  flex-direction: column;\n"])), spaceM$5);
var MonthText = styled$1.p(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  ", "\n  align-self: flex-start;\n  padding-left: ", "px;\n"], ["\n  ", "\n  align-self: flex-start;\n  padding-left: ", "px;\n"])), baseText, spaceM$5);
...
var DayOfWeekGrid = function (_a) {
    ...
    var GREED_DATA = useMemo(function () {
...
var SliderContainer = styled$1(Container)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  padding: ", "px 0;\n  width: 100%;\n  min-width: 224px;\n  justify-content: space-between;\n"], ["\n  padding: ", "px 0;\n  width: 100%;\n  min-width: 224px;\n  justify-content: space-between;\n"])), spaceS$1);
var SliderButton = styled$1(Button)(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  width: 16px;\n  height: 16px;\n"], ["\n  width: 16px;\n  height: 16px;\n"])));
var Title = styled$1.h1(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  ", "\n  font-size: ", "px;\n  font-weight: ", ";\n  cursor: pointer;\n"], ["\n  ", "\n  font-size: ", "px;\n  font-weight: ", ";\n  cursor: pointer;\n"])), baseText, fontSizeM$1, fontWeightL$1);
...
var GridSlider = React.memo(function (_a) {
    ...
    var handleGridChange = useCallback(function (direction) { return function () {
    ...
    return (jsxs(SliderContainer, { children: [jsx(SliderButton, { "data-testid": "prev-button", onClick: handleGridChange(PREV_GRID), children: jsx(Icon, { src: PrevGreedIcon }) }), jsx(Title, { "data-testid": "grid-slider", children: title }), jsx(SliderButton, { "data-testid": "next-button", onClick: handleGridChange(NEXT_GRID), children: jsx(Icon, { src: NextGreedIcon }) })] }));
});
...
var DatePickerContainer = styled$1(Container)(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  flex-direction: column;\n  align-items: flex-start;\n"], ["\n  flex-direction: column;\n  align-items: flex-start;\n"])));
var Label = styled$1.label(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  ", "\n  font-size: ", "px;\n"], ["\n  ", "\n  font-size: ", "px;\n"])), baseText, fontSizeL);
var DatePickerInputWrapper = styled$1(Container)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  border: 1px solid ", ";\n  padding: ", "px;\n  margin: ", "px 0;\n  gap: ", "px;\n  width: 246px;\n  justify-content: flex-start;\n  border-radius: 8px;\n  position: relative;\n"], ["\n  border: 1px solid ", ";\n  padding: ", "px;\n  margin: ", "px 0;\n  gap: ", "px;\n  width: 246px;\n  justify-content: flex-start;\n  border-radius: 8px;\n  position: relative;\n"])), grayColor, spaceM$3, spaceM$3, spaceS);
var Error$1 = styled$1.span(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n  font-size: ", "px;\n  font-weight: ", ";\n  color: ", ";\n"], ["\n  ", "\n  font-size: ", "px;\n  font-weight: ", ";\n  color: ", ";\n"])), baseText, fontSizeS, fontWeightS, redColor$1);
var CalendarWrapper = styled$1.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: absolute;\n  top: 56%;\n"], ["\n  position: absolute;\n  top: 56%;\n"])));
...
var DatePicker = React.memo(function (_a) {
    ...
    var _d = useState(false), isCalendarOpen = _d[0], setIsCalendarOpen = _d[1];
    var selectedDate = useCalendar().selectedDate;
    var setRange = useDate().setRange;
    useEffect(function () {
        setInputValue(formatDate(selectedDate));
    }, [selectedDate]);
    var handleCalendarIconClick = useCallback(function () {
        setInputValue(formatDate(selectedDate));
    ...
    return (jsxs(DatePickerContainer, { children: [jsx(Label, { children: label }), error && jsx(Error$1, { children: error }), jsxs(DatePickerInputWrapper, { children: [jsx(Icon, { "data-testid": "calendar-icon-button", src: CaledarIcon, onClick: handleCalendarIconClick }), jsx(DatePickerInput$1, { inputValue: rangeValue || inputValue, setError: setError, setInputValue: setInputValue, setIsCalendarOpen: setIsCalendarOpen }), inputValue && (jsx(Icon, { "data-testid": "clear-icon-button", src: ClearIcon, onClick: handleClearInput }))] }), jsx(CalendarWrapper, { children: isCalendarOpen && jsx(Calendar, {}) })] }));
});
...
var RangeDatePickerWrapper = styled$1(Container)(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  flex-direction: row;\n  gap: ", "px;\n"], ["\n  flex-direction: row;\n  gap: ", "px;\n"])), spaceM$2);
...
var RangeDatePicker = React.memo(function (_a) {
    ...
    return (jsx(ThemeWrapper, { children: jsxs(RangeDatePickerWrapper, { children: [jsx(DatePicker, { Calendar: Calendar, label: RANGE_FROM, rangeValue: rangeStart }), jsx(DatePicker, { Calendar: Calendar, label: RANGE_TO, rangeValue: rangeEnd })] }) }));
});
...
var DateInput = styled$1(BaseInput)(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  margin: 0;\n"], ["\n  margin: 0;\n"])));
...
var DatePickerInput = React.memo(function (_a) {
    ...
    return (jsx(DateInput, { "data-testid": "date-picker-input", placeholder: PLACEHOLDER$1, type: "text", value: inputValue, onChange: handleInputChange, onKeyDown: handleKeyDown }));
});
...
var Wrapper = styled$1(Container)(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  gap: ", "px;\n  width: 100%;\n"], ["\n  gap: ", "px;\n  width: 100%;\n"])), spaceM$1);
var InputWrapper = styled$1(Container)(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  border: 1px solid ", ";\n  margin: ", "px 0;\n  width: 100%;\n  justify-content: flex-start;\n  border-radius: 8px;\n"], ["\n  border: 1px solid ", ";\n  margin: ", "px 0;\n  width: 100%;\n  justify-content: flex-start;\n  border-radius: 8px;\n"])), lightGrayColor$1, spaceM$1);
var InputButton = styled$1(Button)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  width: 100px;\n  height: 40px;\n  border-radius: 8px;\n"], ["\n  background-color: ", ";\n  color: ", ";\n  width: 100px;\n  height: 40px;\n  border-radius: 8px;\n"])), darkBlueColor, whiteColor);
...
var TodoInput = React.memo(function (_a) {
    ...
    return (jsxs(Wrapper, { children: [jsx(InputWrapper, { children: jsx(BaseInput, { placeholder: PLACEHOLDER, type: "text", value: todoText, onChange: handleInputChange, onKeyDown: handleInputKeyDown }) }), jsx(InputButton, { onClick: handleAddTodo, children: BUTTON_TEXT$1 })] }));
});
...
var TodoWrapper = styled$1(Container)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  border: 1px solid ", ";\n  gap: ", "px;\n  padding: ", "px;\n  justify-content: flex-start;\n  width: 100%;\n  border-radius: 8px;\n"], ["\n  border: 1px solid ", ";\n  gap: ", "px;\n  padding: ", "px;\n  justify-content: flex-start;\n  width: 100%;\n  border-radius: 8px;\n"])), lightGrayColor, spaceM, spaceM);
var TodoText = styled$1.p(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  ", "\n  text-decoration: ", ";\n  width: 100%;\n  max-width: 433px;\n  word-wrap: break-word;\n"], ["\n  ", "\n  text-decoration: ", ";\n  width: 100%;\n  max-width: 433px;\n  word-wrap: break-word;\n"])), baseText, function (_a) {
    var $isDone = _a.$isDone;
    return ($isDone ? "line-through" : "none");
});
var DeleteTaskButton = styled$1(Button)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  &:hover {\n    color: ", ";\n  }\n"], ["\n  &:hover {\n    color: ", ";\n  }\n"])), redColor);
...
var TodoItem = React.memo(function (_a) {
    ...
    var handleDeleteTodo = useCallback(function () {
        var TODO_CACHE_KEY = selectedDate.toDateString();
        var todos = getCache(TODO_CACHE_KEY);
    ...
    return (jsxs(TodoWrapper, { children: [jsx("input", { checked: isDone, type: "checkbox", onChange: handleCheckboxChange }), jsx(TodoText, { "$isDone": isDone, children: todoText }), jsx(DeleteTaskButton, { onClick: handleDeleteTodo, children: BUTTON_TEXT })] }));
});
var TodoItem$1 = TodoItem;

export { Calendar, ClearButton, DatePicker, DatePickerInput$1 as DatePickerInput, DayofWeek as DayOfWeek, DayOfWeekGrid, ErrorBoundary, GridSlider, Modal, RangeDatePicker, ThemeWrapper, TodoInput$1 as TodoInput, TodoItem$1 as TodoItem, TodosModal, Weekday, WeekdaysHeader };
